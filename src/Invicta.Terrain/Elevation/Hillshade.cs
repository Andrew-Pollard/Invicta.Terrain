...
internal static class Hillshade
{
    ...
    private static readonly double s_sunUp = double.Sqrt(0.5);
    ...
    public static double Brightness(double slopeEast, double slopeNorth)
    {
        ...
        double length = double.Sqrt((slopeEast * slopeEast) + (slopeNorth * slopeNorth) + 1);

        return double.Max(0, towardSun / length);
    }
}
