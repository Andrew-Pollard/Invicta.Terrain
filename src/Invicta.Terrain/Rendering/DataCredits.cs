...
public static class DataCredits
{
    ...
    /// <summary>The credit the Open Database License requires for OpenStreetMap data.</summary>
    public const string OpenStreetMap = "Summits © OpenStreetMap contributors.";
}
